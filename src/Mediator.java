...
public class Mediator implements MediatorInterface {
    ...
    public int[] constructProposal(Strategy strategy, int[] contract) {
        return switch (strategy) {
            case SWAP -> constructProposal_SWAP(contract);
            case SHIFT -> constructProposal_SHIFT(contract);
            case REVERSE -> constructProposal_REVERSE(contract);
            case SCRAMBLE -> constructProposal_SCRAMBLE(contract);
            case TWO_POINT_SWAP -> constructProposal_TWO_POINT_SWAP(contract);
            case CYCLE_SHIFT -> constructProposal_CYCLE_SHIFT(contract);
        };
    }
